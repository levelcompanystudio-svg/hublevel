...
export function FilterBar({ children, label = 'Visualizacao' }: FilterBarProps) {
  return (
    <div className="flex flex-col gap-3 rounded-xl border border-border bg-card/70 px-4 py-3.5 backdrop-blur-sm sm:flex-row sm:items-center sm:justify-between">
