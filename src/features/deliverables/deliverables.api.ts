...
// Nao existe tabela `deliverables` no schema atual. Esta camada deriva "entregaveis" de
// dados ja existentes, reaproveitando listTasks()/listDocuments()/listUpdates() sem criar
// nenhuma query nova:
